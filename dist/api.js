...
if (process.env.REDIS_URL) {
    ...
    const checkRedis = () => new Promise((resolve, reject) => {
        ...
        redis.ping().then(res => resolve(res === "PONG"), reject);
    });
    healthCheck = () => __awaiter(void 0, void 0, void 0, function* () {
        return ((yield checkHafas()) === true &&
            (yield checkRedis()) === true);
    });
}
const modifyRoutes = (routes) => (Object.assign(Object.assign({}, routes), { "/stations": stations, "/stations/:id": station, "/lines": lines, "/lines/:id": line, "/shapes/:id": shape, "/maps/:type": maps }));
